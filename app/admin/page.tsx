  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm p-8 bg-white rounded-xl shadow-sm">
        <h1 className="text-2xl font-semibold text-gray-900 mb-2 text-center">Admin Login</h1>
        <p className="text-sm text-gray-500 mb-8 text-center">Enter password to access the admin panel</p>
